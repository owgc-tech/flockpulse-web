...
export default async function AttendanceReportPage() {
  ...
  // STORY-9.2: read-accessible to Leader-tier — RBAC scoping to assigned
  ...
  return (
    <div className="flex flex-col">
      <div className="border-b border-zinc-200 px-6 py-4 dark:border-zinc-800">
        <h1 className="text-xl font-semibold text-zinc-900 dark:text-zinc-50">Attendance Report</h1>
        <p className="mt-0.5 text-sm text-zinc-500 dark:text-zinc-400">
          Attendance reporting, filterable by event, group, and member.
        </p>
      </div>
